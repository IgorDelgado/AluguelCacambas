...
namespace Aluguel.Controllers
{
    public class ColaboradoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,NomeColaborador,Funcao")] Colaborador colaborador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,NomeColaborador,Funcao")] Colaborador colaborador)
        {
